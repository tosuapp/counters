...
## Getting Started
If you are new to GitHub or this repository, follow these steps to get your overlay submitted. You can use [quickstart](quickstart/) as a template for your own.
...
Each overlay **must be self-contained** within its own directory under the [`counters/`](counters/) folder.
...
Refer to [this wiki page](https://github.com/tosuapp/tosu/wiki/The-metadata-of-an-overlay.) for a detailed guide on structuring this file.
...
- The [tosu socket](quickstart/js/socket.js) should remain unminified and must be up to date at the time of your PR.
...
You've reached to bottom of the contributing guide. [Jump to top](#contributing-to-the-tosu-repository-of-overlays)
