...
3. Download [metadata.txt](https://github.com/cyperdark/osu-counters/blob/master/quickstart/metadata.txt), if you don't have it already, and replace it with your metadata
