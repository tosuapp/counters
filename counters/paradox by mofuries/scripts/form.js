    ...
    if (saved.apiKey !== null && saved.apiKey !== '') {
        ...
        .then(userData => {
            ...
            setTimeout(() => {
                ...
                item4.innerHTML = '<span class="colored hash hilight">&nbsp;#</span>' + `<span class="ranksub">${addCommasToNumber(cacheUserData.pp_country_rank)}</span><img class="countryflag" src="https://assets.ppy.sh/old-flags/${cacheUserData.country.toUpperCase()}.png">`;
                ...
                document.getElementById('detailitem1').innerHTML = `<span id="username">${cacheUserData.username}</span><img class="countryflag" src="https://assets.ppy.sh/old-flags/${cacheUserData.country.toUpperCase()}.png">`;
